<template>
  <div>
    ...
    <el-dialog title="分配权限" :visible.sync="setRightDialogVisible" width="50%" @close="setRightDialogColsed">
      <el-tree ref="treeRef" :data="rightLists" :props="treeProps" show-checkbox node-key="id" default-expand-all :default-checked-keys="defKeys"></el-tree>
...
<script>
import { getRoles, deleteRoleRight, getRightsTree, postAllotRights } from "network/home";
export default {
  name: "Roles",
  data() {
    return {
  ...
  methods: {
    ...
    allotRights() {
      let _this = this;
      const arr = [..._this.$refs.treeRef.getCheckedKeys(), 
